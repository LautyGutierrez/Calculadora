...
boton_eliminar = Button(ventana, text = "AC", width = 5, height = 2, command = lambda: eliminar())
...
boton_mas = Button(ventana, text = "+", width = 5, height = 2, command = lambda: click_boton("+"))
boton_menos = Button(ventana, text = "-", width = 5, height = 2, command = lambda: click_boton("-"))
boton_mul = Button(ventana, text = "*", width = 5, height = 2, command = lambda: click_boton("*"))
